...
SECRET_KEY = 'django-insecure-j9vb5p8l3r4809__t!f1wk75^8qd%p^10q#3+((cbvhge%(f^g'

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = strtobool(getenv('DEBUG', 'False'))
DEBUG = strtobool(getenv('DEBUG', 'True'))
...
DATABASES = {
    'default': dj_database_url.config(
        default=getenv('DATABASE_URL', default='postgres://weather:weather@db/weather'),
        conn_max_age=600
    )
}
